...
})({"hQ1Pe":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "943612c2ebc2bef3";
"use strict";
...
class GrassScene {
    constructor(container, visitedFromMobileDevice, modelLoader){
        ...
        this.pointLight = new _three.PointLight(0xfcb43a, 1.5, 2);
    ...
    setEnvMapFromPromise(envMapPromise) {
        envMapPromise.then((texture)=>{
            this.envMap = texture;
    ...
    loadModel() {
        this.modelLoader.loadModel("./assets/models/grass/grass.glb").then((grassModel)=>{
    ...
    loadTextures() {
        this.textures = {
            diffuse: this.modelLoader.ktx2Loader.load("./assets/models/grass/Albedo.ktx2")
        };
    }
...
},{"three":"ktPTu","three-custom-shader-material/vanilla":"7rL7K","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hQ1Pe"], null, "parcelRequire2041")

//# sourceMappingURL=GrassScene.ebc2bef3.js.map
